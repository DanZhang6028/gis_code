...
This is a nootbook a a a a from dan.
...
hahahahahah still testingggggg
```{r test markdown}
library(tidyverse)
library(geojsonio)
library(sf)
...
LondonMapSF <- append_data(LondonMapSF,LondonData, key.shp = "lad15cd", key.data = "NewCode", ignore.duplicates = TRUE)
#plot a choropleth
qtm(LondonMapSF, fill = "RateOfNot.BornInUK_2011")
